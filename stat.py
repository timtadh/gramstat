...
#- Production Dependence
    #- If X occurs with what probability does Y occur
#- Production sequences ^ similar
#- Randomly and uniformly select a production apply
#- Product Coverage vs. Code Coverage
    #- lookup production coverage
#- Evaluate Tests Generated by a Fuzz Tester vs Real Inputs
#- Show for one or more real applications, (or see if its true) that the
    #the -grammatical-complexity-
    #- the difference between the naive fuzz and real
    #- relevant to revealing past faults
    #- show that no naive enumeration scheme is likely to create the inputs
        #required to find those bugs.
        #- Some tools start to the test set
